...
var pwd = flagPwd == 'true' ? true : false;
    	...
    	$("#js-update-pwd").on("click", function(){
    	      ...
    	      dialog.show({
    		   ...
    		   // 修改密码
    		  	...
    		  	$self.validate({
    		     	  rules:{
    					 oldPasswordstr:{required:true},
    					 passwordstr:{required:true, minlength:8,checkPwd:true},
    					 chkpassword:{required:true, equalTo:"#passwordstr"}
    		     	  },
    		          messages:{
    				  	chkpassword:{
    					  	equalTo:"两次输入的密码不相同"
