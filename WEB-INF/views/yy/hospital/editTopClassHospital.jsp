...
<div class="wrap">
    <div class="tb-head">医院管理&gt;&gt;修改医院</div>
    <div class="tb-content">
        <div class="tb-wrap">
            <form id="editTopClassHospital-js-form">
                <table class="table wrap-table">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="col-sm-10"><input type="text" name="name" value="${hospital.name }" class="form-control" placeholder="医院名称"></div>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <div class="col-sm-10 form-inline">
                             ...
                             <tags:selectbox list="${hospitalGradeList}" name="grade" value="${hospital.grade}" addNull="true"/>
                            </div>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="col-sm-10"><input type="text" name="appointment" value="${hospital.appointment}" class="form-control" placeholder="预约量"></div>
                        </td>
                    </tr>
                    <tr>
                        <td>医院头像:</td>
                        <td>
                            ...
                            <div class="imglist clearfix">
                            	<div class="pull-left"><img src="${hospital.img}" alt="" id="imgurl" class="form-img"><input type="hidden" id="img" name="img" value="${hospital.img}"><a href="#">删除</a></div>
                            </div>
                        </td>
                    </tr>
                    <tr>
...
<script>
    require([
        ...
        var $self = $("#editTopClassHospital");
        new area({
            $province: $self.find("#js-province"),
            $city: $self.find("#js-city"),
            $district: $self.find("#js-district"),
            url: '${ctx}/area/all',
            provinceCode: '${hospital.province}',
            cityCode: '${hospital.city}',
        });

        $self.find("#js-submit").on("click", function(e){
        	if(_self.find('#editTopClassHospital-js-form').valid()){
    		var $obj = $(this);
    		$obj.hide();
    		common.fetch({
    		    url: '${ctx}/Hospital/editHospital',
    		    type: 'POST',
    		    data: $self.find("#editTopClassHospital-js-form").serialize(),
    		    dataType:"json",
    		    success: function(rt) {
    		    	if(1 == rt.ret_code){
    		    	   //$('#topClassHospital').load("${ctx}/Hospital");
    		    	   //common.closeTab('editTopClassHospital');
    		    	   common.createTab({
			               uri: '${ctx}/Hospital',
			               data: {name: '医院列表'},
			               key: 'topClassHospital',
			               callback: function(){
			                   common.closeTab("editTopClassHospital", null, false);
			               }
			           });
    		       }else{
    		    	   $obj.show();  
        ...
        var action = "${ctx}/upload/uploadFile",_self = $('#editTopClassHospital'),button = _self.find('#choseFile'),interval;
        ...
        $self.find('#editTopClassHospital-js-form').validate({
	        rules:{
	        	name:"required",
	        	grade:"required",
	        	province:"required",
