...
<div class="wrap lectureList">
	<div class="tb-head">健康知识问卷</div>
	<div class="tb-content">
		<div class="tb-wrap">
			<div class="opt clearfix">
				<div class="pull-right">
					<button class="btn btn-main" type="button" id="js-delete">删除</button>
					<button class="btn btn-main" type="button" id="js-create">新增知识问卷活动</button>
				</div>
			</div>
			...
			<tags:pagination page="${pages}" action="${ctx}/healthKnowledge" pageId="healthKnowledge" />
		</div>
	</div>
</div>
...
require([ 'jquery', 'js/cascade' ], function($, cascade){
     	var $self = $("#healthKnowledge");
     	$self.find("#js-create").on("click", function(e){
     		common.createTab({
     			uri: '${ctx}/healthKnowledge/create',
     			data: {name: '新增健康知识问卷'},
     			key: 'newHealthKnowlege'
     		});
     	});
     	...
     	$self.find(".js-update").on("click", function(e){
     		...
     		common.createTab({
     			uri: '${ctx}/healthKnowledge/update/'+id,
     			data: {name: '修改健康知识问卷'},
     			key: 'newHealthKnowlege'
     		});
     	});
     	...
     	$self.find(".js-view").on("click", function(e){
     		var id = $(this).attr('data-id');
     		common.createTab({
     			uri: '${ctx}/healthKnowledge/view/'+id,
     			data: {name: '健康知识问卷详情'},
     			key: 'healthKnowlegeDetail'
     		});
     	});
					...
					function(e) {
						...
						if (strids == '') {
							...
							common.confirm({
					            content:"确认删除？",
					            success:function(){
					                $.get("${ctx}/healthKnowledge/delete/" + strids,function(data){
