...
<div class="wrap roleManager">
	<div class="tb-head">健康教育工作大事记录表</div>
	<div class="tb-content">
		<div class="tb-wrap">
			...
			<tags:pagination page="${pages}" action="${ctx}/healthEducation" pageId="healthEducation" />
		</div>
	</div>
</div>
...
require([ 'jquery' ], function($){
     	var $self = $("#healthEducation");
     	
     	$self.find("#js-search").on("click", function(e){
            common.load({
                container: 'healthEducation',
                url: '${ctx}/healthEducation',
     	...
     	$self.find("#js-create").on("click", function(e){
     		common.createTab({
     			uri: '${ctx}/healthEducation/create',
     			data: {name: '新增健康教育工作大事记录表'},
     			key: 'modifyHealthEducation'
     		});
     	});
     	...
     	$self.find(".js-update").on("click", function(e){
     		...
     		common.createTab({
     			uri: '${ctx}/healthEducation/update/'+id,
     			data: {name: '修改健康教育工作大事记录表'},
     			key: 'modifyHealthEducation'
     		});
     	});
					...
					function(e) {
						...
						if (strids == '') {
							...
							common.confirm({
					            content:"确认删除？",
					            success:function(){
					                $.get("${ctx}/healthEducation/delete/" + strids,function(data){
