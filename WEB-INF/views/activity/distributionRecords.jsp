...
<div class="wrap roleManager">
	<div class="tb-head">健康教育印刷资料分发记录表</div>
	<div class="tb-content">
		<div class="tb-wrap">
			...
			<tags:pagination page="${pages}" action="${ctx}/distributionRecords" pageId="distributionRecords" />
		</div>
	</div>
</div>
...
require([ 'jquery'], function($){
     	var $self = $("#distributionRecords");

     	$self.find("#js-search").on("click", function(e){
            common.load({
                container: 'distributionRecords',
                url: '${ctx}/distributionRecords',
     	...
     	$self.find("#js-create").on("click", function(e){
     		common.createTab({
     			uri: '${ctx}/distributionRecords/create',
     			data: {name: '新增印刷资料分发记录'},
     			key: 'modifyDistributionRecords'
     		});
     	});
     	...
     	$self.find(".js-update").on("click", function(e){
     		...
     		common.createTab({
     			uri: '${ctx}/distributionRecords/update/'+id,
     			data: {name: '修改印刷资料分发记录'},
     			key: 'modifyDistributionRecords'
     		});
     	});
					...
					function(e) {
						...
						if (strids == '') {
							...
							common.confirm({
					            content:"确认删除？",
					            success:function(){
					                $.get("${ctx}/distributionRecords/delete/" + strids,function(data){
