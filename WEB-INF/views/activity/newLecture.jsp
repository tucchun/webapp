...
<div class="wrap">
    <div class="tb-head">健康知识讲座管理&gt;&gt;<c:if test="${action eq 'create' }">新增</c:if><c:if test="${action eq 'update' }">修改</c:if>健康知识讲座</div>
        ...
        <form action="#"  id="js-form">
            ...
            <table class="table wrap-table">
                ...
                <tr>
                    ...
                    <td>
                        <div class="col-sm-8">
                            <input type="text" class="form-control" name="activityPlace" placeholder="健康知识讲座地点" value="${serviceActivity.activityPlace }" />
                        </div>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>
                        <div class="col-sm-8">
                            <input type="text" name="hostUnit" class="form-control" placeholder="主办单位" value="${serviceActivity.hostUnit }" />
                        </div>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <div class="col-sm-8">
                            <input type="text" name="expert" class="form-control" placeholder="授课老师" value="${serviceActivity.expert }" />
                        </div>
                    </td>
                </tr>
                <tr>
    ...
    require(['jquery','js/components-select','js/cascade','validate','message_zh'], function($,select,cascade){
		                     ...
		                     success: function(data){
		                         ...
		                         if(data.ret_code==1){
		                             common.createTab({
		                                 ...
		                                 key: 'lectureList',
		                                 callback: function(){
		                                     common.closeTab("newLecture",null,false);
		                                 }
		                             });
		                         }
		                     }
    	...
    	$self.find('#js-form').validate({
            ...
            messages:{
            	...
            	hostUnit:{required:"请输入主办单位"},
            	expert:{required:"请输入授课老师"},
