...
<div class="wrap">
	<div class="tb-head">资讯管理&gt;&gt;新增文章</div>
				...
				<table class="table wrap-table">
					<tbody>
								...
								<div class="col-sm-10 form-inline">
									<select name="category" class="form-control"> 
										...
										<c:forEach items="${informationList}" var="look">
											<option value="${look.lookup_code }">${look.lookup_value }</option>
										</c:forEach>
									</select>
								</div>
							</td>
						...
						<tr>
							...
							<td>
								<div class="col-sm-2">
									<input type="text" name="source" class="form-control" maxlength="5"
						...
						<tr>
							...
							<td>
								<div class="col-sm-2">
									<input type="text" name="author" class="form-control" maxlength="5"
						...
						<tr>
							...
							<td>
								<div class="col-sm-5">
									<input type="text" name="keyWords" class="form-control" maxlength="50"
						...
						<tr>
                            ...
                            <div class="imglist clearfix">
                            	<div class="pull-left"><img src="" alt="" id="imgurl" class="form-img">
						...
						<tr>
				          ...
				          <td>
				            <div class="col-sm-10">
				              <textarea name="summary" id="summary" rows="5" maxlength="100" class="fill form-control" placeholder="请输入摘要，不超过100个汉字"></textarea>	
				            </div>
                        ...
                        <td>
                            <div class="edit">
                                <textarea name="content" id="newArticle_kindEditor_newArticle" style="width:776px;height:360px;" ></textarea>
                        ...
                        <tr>
							...
							<td>
								<div class="col-sm-2">
									<input type="checkbox" value="1" name="recommendStatus"> 推荐到APP首页
								</div>
							</td>
						</tr>
...
require(["jquery","KindEditor","zh_CN",'js/components-select','js/cascade','upload','validate','js/dialog','message_zh'], 
		...
		$self.find("#js-submit").on("click", function(e) {
			editor.sync('newArticle_kindEditor_newArticle');
			if(!$self.find('#newArticle_kindEditor_newArticle').val()){
    			$self.find('#contents').val('');
    		}else{
    			$self.find('#contents').val('1');
    		}
    		if($self.find('#newArticle_kindEditor_newArticle').val().length > 10000){
	    	    common.alert("详情文本太长!");
    			return false;
    		}
				...
				success : function(rt) {
					if (1 == rt.ret_code) {
						common.createTab({
				               ...
				               key: 'articleList',
				               callback: function(){
				                   common.closeTab("newArticle", null, false);
				               }
				           });
					} else {
						$obj.show();
		...
		var editor = KindEditor.create('#newArticle_kindEditor_newArticle', {
       	 resizeType : 1,
		...
		var action = "${ctx}/upload/uploadFile",_self = $('#newArticle'),button = _self.find('#choseFile'),interval;
