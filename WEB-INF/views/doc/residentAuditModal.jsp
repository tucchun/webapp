...
<div id="modal_residentAudit" class="modal fade">
    <div class="modal-dialog">
        ...
        <div class="modal-body">
            <form class="form-horizontal form-tb clearfix" id="rediedntAudit-form">
...
require([
	...
	$self.find("#js-submit").on("click", function(e){
        if($self.find('#rediedntAudit-form').valid()){
            common.post({
                url: '${ctx}/residentAudit/auditPass',
                data: $self.find("#rediedntAudit-form").serialize(),
                modal: $self.find("#modal_residentAudit"),
                dataType: "JSON"
            }).done(function(data){
	...
	$self.find('#rediedntAudit-form').validate({
        rules:{
