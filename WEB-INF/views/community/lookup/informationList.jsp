...
<div class="wrap professionalTitleManage">
    ...
    <div class="tb-content">
        <div class="tb-wrap">
            ...
            <tags:pagination paginationSize="5" page="${pages }" action="${ctx }/lookup/information" pageId="lookup_information"></tags:pagination>
        </div>
    </div>
</div>
<div id="modal_include_information">
	<jsp:include page="informationModal.jsp" flush="true" />
</div>
<script>
require([
	'jquery'
	...
	$self.find("#js-create").on("click", function(e){
		$.get("${ctx}/lookup/create",{"category":"information"},function(html){
		$self.find("#modal_include_information").html(html);
		$self.find("#modal_information").modal("show");
		},"html");
	});
	
	$self.find(".js-update").on("click", function(e){
		var id = $(this).attr('data-id');
		$.get("${ctx}/lookup/update/"+id,{"category":"information"},function(html){
		$self.find("#modal_include_information").html(html);
	    $self.find("#modal_information").modal("show");
		},"html");
	});
