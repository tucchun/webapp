...
<div class="wrap professionalTitleManage">
    ...
    <div class="tb-content">
        <div class="tb-wrap">
            ...
            <tags:pagination paginationSize="5" page="${pages }" action="${ctx }/lookup/title" pageId="lookup_title"></tags:pagination>
        </div>
    </div>
</div>
<div id="modal_include_title">
        <jsp:include page="titleModal.jsp" flush="true" />
    </div>
<script>
require([
	'jquery'
	...
	$self.find("#js-create").on("click", function(e){
		$.get("${ctx}/lookup/create",{"category":"title"},function(html){
		$self.find("#modal_include_title").html(html);
	...
	$self.find(".js-update").on("click", function(e){
		...
		$.get("${ctx}/lookup/update/"+id,{"category":"title"},function(html){
		$self.find("#modal_include_title").html(html);
	    $self.find("#modal_title").modal("show");
		},"html");
	});
