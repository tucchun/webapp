    ...
    _createClass(JGSSalesStats, [{
        ...
        value: function handleClickExport() {
            ...
            (0, _http2.default)({
                ...
                (0, _Util.downloadExcel)(res, '销售统计');
            }, function (error) {
                common.alert(error);
            });
        }
...
_reactDom2.default.render(_react2.default.createElement(JGSSalesStats, null), document.getElementById('__jgssalesStats/jgssalesStats__'));
