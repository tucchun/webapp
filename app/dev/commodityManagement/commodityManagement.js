...
var httpServer = function httpServer() {
  ...
  switch (arguments.length) {
    case 1:
      ...
      config = _lodash2.default.omit(arguments[0], 'url', 'data');
      break;
    case 2:
      url = arguments[0];
      data = arguments[1].data;
      config = _lodash2.default.omit(arguments[1], 'data');
      break;
    case 3:
      url = arguments[0];
      data = arguments[1];
  ...
  return (0, _axios2.default)(url, data, config);
};
...
/***/ "./app/page/commodityManagement/commodityManagement.js":
/***/ (function(module, exports, __webpack_require__) {
...
var _form = __webpack_require__("./app/page/commodityManagement/form.js");

var _form2 = _interopRequireDefault(_form);

__webpack_require__("./app/page/commodityManagement/style.css");
...
var CommodityManagement = function (_Component) {
  _inherits(CommodityManagement, _Component);

  function CommodityManagement(props) {
    _classCallCheck(this, CommodityManagement);

    var _this = _possibleConstructorReturn(this, (CommodityManagement.__proto__ || Object.getPrototypeOf(CommodityManagement)).call(this, props));
  ...
  _createClass(CommodityManagement, [{
    key: 'fetchCommodityData',
    value: function fetchCommodityData() {
      return (0, _http2.default)({ url: _ApiMap2.default.shopStationProdList.url }).then(function (response) {
        return response.data;
      });
    }
  }, {
    key: 'fetchShopProdmeta',
    value: function fetchShopProdmeta() {
      return (0, _http2.default)({ url: _ApiMap2.default.shopProdmeta.url }).then(function (response) {
        return response.data;
      });
    }
  }, {
    ...
    value: function componentDidMount() {
      ...
      this.fetchCommodityData().then(function (data) {
        if (data.ret_code === 1) {
          var pageNumber = Math.ceil(data.ret_data.total / _this2.state.pageCount);
          _this2.setState({ girdData: data.ret_data.prod_list, total: data.total, pageNumber: pageNumber });
        } else {
          // alert(data.ret_msg);
        }
      }).catch(function () {
      ...
      this.fetchShopProdmeta().then(function (data) {
        if (data.ret_code === 1) {
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          _Condition2.default,
          null,
          _react2.default.createElement(_form2.default, { cats: this.state.cats, crowds: this.state.crowds, tags: this.state.tags })
        ),
        _react2.default.createElement(_Table2.default, { rowKey: 'prod_id', columns: this.columns, data: this.state.girdData }),
        _react2.default.createElement(_pageNation2.default, { getPage: this.handleGetPage, currentPage: this.state.currentPage, pageNumber: this.state.pageNumber })
      );
    }
  }]);
...
_reactDom2.default.render(_react2.default.createElement(CommodityManagement, null), document.getElementById('__commodityManagement/commodityManagement__'));

/***/ }),

/***/ "./app/page/commodityManagement/form.js":
/***/ (function(module, exports, __webpack_require__) {
...
var Condition = function (_Component) {
  ...
  function Condition(props) {
    ...
    _this.handle_prod_assist_code = _this.handle_prod_assist_code.bind(_this);
    return _this;
  }
  ...
  _createClass(Condition, [{
    ...
    key: 'handle_prod_assist_code',
    value: function handle_prod_assist_code(e) {
      this.setState({
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          ' ',
          _react2.default.createElement(_reactBootstrap.FormControl, { type: 'text', onChange: this.handle_prod_assist_code, value: this.state.prod_assist_code, placeholder: '\u52A9\u8BB0\u7801' })
        ),
        ' ',
        _react2.default.createElement(
          _reactBootstrap.FormGroup,
          ...
          ' ',
          _react2.default.createElement(_reactBootstrap.FormControl, { type: 'text', placeholder: '\u5546\u54C1\u540D\u79F0' })
        ),
        ' ',
        _react2.default.createElement(
          _reactBootstrap.FormGroup,
          ...
          ' ',
          _react2.default.createElement(_reactBootstrap.FormControl, { type: 'text', placeholder: '\u5546\u54C1\u4EA7\u5730' })
        ),
        ' ',
        _react2.default.createElement(
          _reactBootstrap.FormGroup,
          ...
          _react2.default.createElement(
            ...
            { componentClass: 'select', placeholder: '\u662F\u5426\u4E0A\u67B6' },
            _react2.default.createElement(
              'option',
              { value: '' },
              '\u8BF7\u9009\u62E9'
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            { bsClass: 'btn btn-main', onClick: this.handleSubmit, type: 'button' },
            '\u67E5\u8BE2'
          )
        ),
        _react2.default.createElement(
            ...
            _react2.default.createElement(
              ...
              _react2.default.createElement(
                ...
                tags.map(function (tag) {
                  return _react2.default.createElement(
                    _reactBootstrap.Checkbox,
                    { key: tag.tag_id, value: tag.tag_no, inline: true },
                    tag.tag_text
                  );
                })
              )
            ...
            _react2.default.createElement(
              ...
              _react2.default.createElement(
                ...
                crowds.map(function (crowd) {
                  return _react2.default.createElement(
                    _reactBootstrap.Checkbox,
                    { key: crowd.crowd_id, value: crowd.crowd_id, inline: true },
                    crowd.crowd_text
                  );
                })
              )
          ...
          _react2.default.createElement(
            ...
            cats.map(function (cat) {
              var sub_cats = cat.sub_cats.map(function (sub_cat) {
                return _react2.default.createElement(
                  _reactBootstrap.Checkbox,
                  { key: sub_cat.cat_id, inline: true, value: sub_cat.cat_id },
                  sub_cat.cat_text
                );
              });
              return _react2.default.createElement(
                ...
                _react2.default.createElement(
                  ...
                  _react2.default.createElement(
                    _reactBootstrap.Checkbox,
                    { inline: true, key: cat.cat_id, value: cat.cat_id },
                    cat.cat_text
                  ),
                  _react2.default.createElement(
                    'div',
...
/***/ "./app/page/commodityManagement/style.css":
/***/ (function(module, exports, __webpack_require__) {

// style-loader: Adds some css to the DOM by adding a <style> tag

// load the styles
var content = __webpack_require__("./node_modules/css-loader/index.js?{\"modules\":false}!./node_modules/postcss-loader/lib/index.js!./app/page/commodityManagement/style.css");
if(typeof content === 'string') content = [[module.i, content, '']];
// Prepare cssTransformation
var transform;
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../../../node_modules/css-loader/index.js??ref--1-1!../../../node_modules/postcss-loader/lib/index.js!./style.css", function() {
			var newContent = require("!!../../../node_modules/css-loader/index.js??ref--1-1!../../../node_modules/postcss-loader/lib/index.js!./style.css");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
...
/***/ "./node_modules/css-loader/index.js?{\"modules\":false}!./node_modules/postcss-loader/lib/index.js!./app/page/commodityManagement/style.css":
/***/ (function(module, exports, __webpack_require__) {
...
// module
exports.push([module.i, ".commodityManagement-cats{margin:10px 0}.commodityManagement-pl20{padding-left:20px}.commodityManagement-cats .form-group{vertical-align:top;padding-right:10px}", ""]);
...
/***/ "./node_modules/css-loader/index.js?{\"modules\":false}!./node_modules/postcss-loader/lib/index.js!./static/assets/jquery.mloading-master/src/jquery.mloading.css":
/***/ (function(module, exports, __webpack_require__) {
...
// module
exports.push([module.i, ".mloading-container{position:relative;min-height:70px;-webkit-transition:height .6s ease-in-out;transition:height .6s ease-in-out}.mloading{position:absolute;background:#e9e9e8;font:normal 12px/22px Microsoft Yahei,微软雅黑,宋体;display:none;z-index:1;background:hsla(60,2%,91%,0)}.mloading.active{display:block}.mloading.mloading-mask{background:hsla(60,2%,91%,.75);filter:progid:DXImageTransform.Microsoft.Alpha(opacity=75)}.mloading-full{position:fixed}.mloading-container>.mloading,.mloading-full{width:100%;height:100%;top:0;left:0}.mloading-body{width:100%;height:100%;position:relative}.mloading-bar{width:250px;min-height:22px;text-align:center;background:#fff;-webkit-box-shadow:0 1px 2px rgba(0,0,0,.27);box-shadow:0 1px 2px rgba(0,0,0,.27);border-radius:7px;padding:20px 15px;font-size:14px;color:#999;position:absolute;top:50%;left:50%;margin-left:-140px;margin-top:-30px;word-break:break-all}@media (max-width:300px){.mloading-bar{width:62px;height:56px;margin-left:-30px!important;margin-top:-30px!important;padding:0;line-height:56px}.mloading-bar>.mloading-text{display:none}}.mloading-bar-sm{width:62px;height:56px;margin-left:-30px!important;margin-top:-30px!important;padding:0;line-height:56px}.mloading-bar-sm>.mloading-text{display:none}.mloading-icon{width:16px;height:16px;vertical-align:middle}.mloading-text{margin-left:10px}", ""]);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__utils_TransitionEvents__ = __webpack_require__("./node_modules/react-bootstrap/es/utils/TransitionEvents.js");
...
"use strict";
/* WEBPACK VAR INJECTION */(function(process) {/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_extends__ = __webpack_require__("./node_modules/babel-runtime/helpers/extends.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_extends___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_extends__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_babel_runtime_helpers_objectWithoutProperties__ = __webpack_require__("./node_modules/babel-runtime/helpers/objectWithoutProperties.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_babel_runtime_helpers_objectWithoutProperties___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_babel_runtime_helpers_objectWithoutProperties__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_babel_runtime_helpers_classCallCheck__ = __webpack_require__("./node_modules/babel-runtime/helpers/classCallCheck.js");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8_prop_types__ = __webpack_require__("./node_modules/prop-types/index.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8_prop_types___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_8_prop_types__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9_react_overlays_lib_Transition__ = __webpack_require__("./node_modules/react-overlays/lib/Transition.js");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_prop_types__ = __webpack_require__("./node_modules/prop-types/index.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_prop_types___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_6_prop_types__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_react_overlays_lib_Transition__ = __webpack_require__("./node_modules/react-overlays/lib/Transition.js");
...
"use strict";
/* WEBPACK VAR INJECTION */(function(process) {/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_objectWithoutProperties__ = __webpack_require__("./node_modules/babel-runtime/helpers/objectWithoutProperties.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_objectWithoutProperties___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_objectWithoutProperties__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_babel_runtime_helpers_classCallCheck__ = __webpack_require__("./node_modules/babel-runtime/helpers/classCallCheck.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_babel_runtime_helpers_classCallCheck___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_babel_runtime_helpers_classCallCheck__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_babel_runtime_helpers_possibleConstructorReturn__ = __webpack_require__("./node_modules/babel-runtime/helpers/possibleConstructorReturn.js");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8_prop_types_extra_lib_elementType__ = __webpack_require__("./node_modules/prop-types-extra/lib/elementType.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8_prop_types_extra_lib_elementType___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_8_prop_types_extra_lib_elementType__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__PaginationButton__ = __webpack_require__("./node_modules/react-bootstrap/es/PaginationButton.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__utils_bootstrapUtils__ = __webpack_require__("./node_modules/react-bootstrap/es/utils/bootstrapUtils.js");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8_prop_types__ = __webpack_require__("./node_modules/prop-types/index.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8_prop_types___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_8_prop_types__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__Collapse__ = __webpack_require__("./node_modules/react-bootstrap/es/Collapse.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__utils_bootstrapUtils__ = __webpack_require__("./node_modules/react-bootstrap/es/utils/bootstrapUtils.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__utils_StyleConfig__ = __webpack_require__("./node_modules/react-bootstrap/es/utils/StyleConfig.js");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_49__PaginationButton__ = __webpack_require__("./node_modules/react-bootstrap/es/PaginationButton.js");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_prop_types_extra_lib_utils_createChainableTypeChecker__ = __webpack_require__("./node_modules/prop-types-extra/lib/utils/createChainableTypeChecker.js");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__ValidComponentChildren__ = __webpack_require__("./node_modules/react-bootstrap/es/utils/ValidComponentChildren.js");
...
// load the styles
var content = __webpack_require__("./node_modules/css-loader/index.js?{\"modules\":false}!./node_modules/postcss-loader/lib/index.js!./static/assets/jquery.mloading-master/src/jquery.mloading.css");
if(typeof content === 'string') content = [[module.i, content, '']];
// Prepare cssTransformation
var transform;
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../../../../node_modules/css-loader/index.js??ref--1-1!../../../../node_modules/postcss-loader/lib/index.js!./jquery.mloading.css", function() {
			var newContent = require("!!../../../../node_modules/css-loader/index.js??ref--1-1!../../../../node_modules/postcss-loader/lib/index.js!./jquery.mloading.css");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
...
"use strict";
/* WEBPACK VAR INJECTION */(function(module) {var __WEBPACK_AMD_DEFINE_RESULT__;var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;
...
//# sourceMappingURL=commodityManagement.js.map