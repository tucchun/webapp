...
var ModalDemo = function (_React$Component2) {
    _inherits(ModalDemo, _React$Component2);

    function ModalDemo(props) {
        _classCallCheck(this, ModalDemo);

        var _this2 = _possibleConstructorReturn(this, (ModalDemo.__proto__ || Object.getPrototypeOf(ModalDemo)).call(this, props));
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    { bsStyle: 'primary', onClick: function onClick() {
                            return _this3.setState({ lgShow: true });
                        } },
                    '\u70B9\u51FB\u5F39\u7A97'
                ),
                _react2.default.createElement(Dialog, { show: this.state.lgShow, onHide: lgClose })
            );
        }
    }]);
...
_reactDom2.default.render(_react2.default.createElement(ModalDemo, { lgShow: false }), document.getElementById('__dialog__'));
