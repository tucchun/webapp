...
/***/ "./app/page/commodityStats/commodityStats.js":
/***/ (function(module, exports, __webpack_require__) {
...
var CommodityStats = function (_Component) {
    _inherits(CommodityStats, _Component);

    function CommodityStats(props) {
        _classCallCheck(this, CommodityStats);

        var _this = _possibleConstructorReturn(this, (CommodityStats.__proto__ || Object.getPrototypeOf(CommodityStats)).call(this, props));
    ...
    _createClass(CommodityStats, [{
        ...
        key: 'getShopProdSaleStat',
        value: function getShopProdSaleStat() {
            var _this2 = this;
            ...
            (0, _http2.default)({
                url: _ApiMap2.default.getShopProdSaleStat.url,
                method: _ApiMap2.default.getShopProdSaleStat.method,
        ...
        value: function handleClickExport() {
            ...
            (0, _http2.default)({
                url: _ApiMap2.default.shopProdSaleStatExport.url,
                method: _ApiMap2.default.shopProdSaleStatExport.method,
                data: JSON.stringify(parms),
                responseType: 'blob'
            }).then(function (res) {
                (0, _Util.downloadExcel)(res, '商品销售统计');
            }, function (error) {
                common.alert(error);
            });
        }
...
_reactDom2.default.render(_react2.default.createElement(CommodityStats, null), document.getElementById('__commodityStats/commodityStats__'));
